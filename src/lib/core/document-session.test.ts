...
import { createDocumentSession, fileNameOf } from "./document-session";
...
describe("createDocumentSession", () => {
  ...
  let file: { content: string; path: string };
  ...
  beforeEach(() => {
    ...
    confirmed = true;
    confirmMessages = [];
    file = { content: "磁盘内容", path: "/tmp/a.typ" };
    readError = undefined;
  });
