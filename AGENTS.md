...
npm test             # 单测（53 文件 / 964 项）；npm test -- <文件> 跑单个
...
CDP_PORT=9335 BROWSER_CHECK_PORT=1425 node scripts/browser-check/writing-stability.mjs        # 改公式/锚点/模式切换必跑（56 项）
